...
public class ModWaxable {
    public static void registerWaxable() {
        ...
        OxidizableBlocksRegistry.registerWaxableBlockPair(Blocks.IRON_DOOR, ModBlocks.WAXED_IRON_DOOR);
        ...
        OxidizableBlocksRegistry.registerWaxableBlockPair(Blocks.IRON_TRAPDOOR, ModBlocks.WAXED_IRON_TRAPDOOR);
        ...
        OxidizableBlocksRegistry.registerWaxableBlockPair(Blocks.IRON_BARS, ModBlocks.WAXED_IRON_BARS);
