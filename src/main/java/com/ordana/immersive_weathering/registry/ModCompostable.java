...
public class ModCompostable {
    public static void registerCompostable() {
        ComposterBlock.COMPOSTABLES.put(ModItems.MOSS_CLUMP, 0.5f);
        ComposterBlock.COMPOSTABLES.put(ModItems.AZALEA_FLOWERS, 0.5f);
        ComposterBlock.COMPOSTABLES.put(ModItems.OAK_BARK, 0.8f);
        ComposterBlock.COMPOSTABLES.put(ModItems.SPRUCE_BARK, 0.8f);
        ComposterBlock.COMPOSTABLES.put(ModItems.BIRCH_BARK, 0.8f);
        ComposterBlock.COMPOSTABLES.put(ModItems.JUNGLE_BARK, 0.8f);
        ComposterBlock.COMPOSTABLES.put(ModItems.ACACIA_BARK, 0.8f);
        ComposterBlock.COMPOSTABLES.put(ModItems.DARK_OAK_BARK, 0.8f);
        ...
        ComposterBlock.COMPOSTABLES.put(ModItems.MOSS_CLUMP.asItem(), 0.5f);
