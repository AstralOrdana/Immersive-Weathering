...
public class FallingSandLayerEntity extends ImprovedFallingBlockEntity {
    ...
    public FallingSandLayerEntity(EntityType<FallingSandLayerEntity> type, World level) {
        super(type, level);
    }

    public FallingSandLayerEntity(World level) {
        super(ModEntities.FALLING_SAND_LAYER, level);
    }

    public FallingSandLayerEntity(World level, BlockPos pos, BlockState blockState) {
        super(ModEntities.FALLING_SAND_LAYER, level, pos, blockState, false);
    }

    public static FallingSandLayerEntity fall(World level, BlockPos pos, BlockState state) {
