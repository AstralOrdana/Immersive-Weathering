...
public class WeatheredRustableStairsBlock extends ExposedRustableStairsBlock {
    public WeatheredRustableStairsBlock(RustLevel rustLevel, BlockState baseBlockState, Settings settings) {
