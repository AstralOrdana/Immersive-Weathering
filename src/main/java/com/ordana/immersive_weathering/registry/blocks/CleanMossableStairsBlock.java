...
public class CleanMossableStairsBlock extends MossableStairsBlock {
    public CleanMossableStairsBlock(MossLevel mossLevel, BlockState baseBlockState, AbstractBlock.Settings settings) {
