...
public class CleanRustableStairsBlock extends RustableStairsBlock{
    public CleanRustableStairsBlock(RustLevel rustLevel, BlockState baseBlockState, Settings settings) {
