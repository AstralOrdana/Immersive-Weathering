...
public class RustedRustableTrapdoorBlock extends WeatheredRustableTrapdoorBlock {
    public RustedRustableTrapdoorBlock(RustLevel rustLevel, Settings settings) {
