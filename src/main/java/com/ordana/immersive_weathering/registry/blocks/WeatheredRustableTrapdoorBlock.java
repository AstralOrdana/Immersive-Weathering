...
public class WeatheredRustableTrapdoorBlock extends ExposedRustableTrapdoorBlock {
    public WeatheredRustableTrapdoorBlock(RustLevel rustLevel, Settings settings) {
