...
public class ModFoods {
    ...
    public static final FoodComponent ICICLE = (new FoodComponent.Builder()).hunger(0).saturationModifier(0F).alwaysEdible().snack().statusEffect(new StatusEffectInstance(StatusEffects.FIRE_RESISTANCE, 300, 1), 1F).build();
}
