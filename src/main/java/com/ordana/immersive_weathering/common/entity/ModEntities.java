...
public class ModEntities {
    ...
    public static final RegistryObject<EntityType<FallingIcicleBlockEntity>> FALLING_ICICLE = regEntity("falling_icicle",
            EntityType.Builder.<FallingIcicleBlockEntity>of(FallingIcicleBlockEntity::new, MobCategory.MISC)
                    .sized(0.98F, 0.98F)
