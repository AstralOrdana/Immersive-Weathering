...
public class ModFoods {
    ...
    public static final FoodProperties SMOKED_WEED = (new FoodProperties.Builder())
            .effect(new MobEffectInstance(MobEffects.DIG_SLOWDOWN, 100, 2), 1F)
            .effect(new MobEffectInstance(MobEffects.WEAKNESS, 100, 1), 1F)
    ...
    public static final FoodProperties WEED = (new FoodProperties.Builder())
            .effect(new MobEffectInstance(MobEffects.HUNGER, 100, 2), 1F)
            .effect(new MobEffectInstance(MobEffects.CONFUSION, 100, 2), 1F)
            .nutrition(0).saturationMod(0.2F).alwaysEat().fast()
            .build();
