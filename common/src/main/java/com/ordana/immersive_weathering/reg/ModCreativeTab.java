...
public class ModCreativeTab {
    ...
    public static void addItems(RegHelper.ItemToTabEvent e) {
        ...
        after(e, Items.STONE_BUTTON, CreativeModeTabs.BUILDING_BLOCKS,
            ModBlocks.MOSSY_STONE, ModBlocks.MOSSY_STONE_SLAB, ModBlocks.MOSSY_STONE_STAIRS, ModBlocks.MOSSY_STONE_WALL,
            ModBlocks.SNOWY_STONE, ModBlocks.SNOWY_STONE_SLAB, ModBlocks.SNOWY_STONE_STAIRS, ModBlocks.SNOWY_STONE_WALL,
            ModBlocks.SANDY_STONE, ModBlocks.SANDY_STONE_SLAB, ModBlocks.SANDY_STONE_STAIRS, ModBlocks.SANDY_STONE_WALL
        );

        after(e, Items.MOSSY_COBBLESTONE_WALL, CreativeModeTabs.BUILDING_BLOCKS,
            ModBlocks.SNOWY_COBBLESTONE, ModBlocks.SNOWY_COBBLESTONE_SLAB, ModBlocks.SNOWY_COBBLESTONE_STAIRS, ModBlocks.SNOWY_COBBLESTONE_WALL,
            ModBlocks.SANDY_COBBLESTONE, ModBlocks.SANDY_COBBLESTONE_SLAB, ModBlocks.SANDY_COBBLESTONE_STAIRS, ModBlocks.SANDY_COBBLESTONE_WALL
        );
        ...
        after(e, Items.MOSSY_STONE_BRICK_WALL, CreativeModeTabs.BUILDING_BLOCKS,
            ...
            ModBlocks.SNOWY_STONE_BRICKS, ModBlocks.SNOWY_STONE_BRICK_SLAB, ModBlocks.SNOWY_STONE_BRICK_STAIRS, ModBlocks.SNOWY_STONE_BRICK_WALL, ModBlocks.SNOWY_CHISELED_STONE_BRICKS,
            ModBlocks.SANDY_STONE_BRICKS, ModBlocks.SANDY_STONE_BRICK_SLAB, ModBlocks.SANDY_STONE_BRICK_STAIRS, ModBlocks.SANDY_STONE_BRICK_WALL, ModBlocks.SANDY_CHISELED_STONE_BRICKS
        );
        ...
        after(e, Items.PRISMARINE_BRICK_SLAB, CreativeModeTabs.BUILDING_BLOCKS,
            ...
            ModBlocks.CRACKED_PRISMARINE_BRICK_SLAB, ModBlocks.CRACKED_PRISMARINE_BRICK_STAIRS, ModBlocks.CRACKED_PRISMARINE_BRICK_WALL
        );
